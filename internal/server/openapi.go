...
func signalPlaneOpenAPI() map[string]any {
	return map[string]any{
		...
		"paths": map[string]any{
			...
			"/api/alert-rules":                     pathItem(getOp("Alert rules", "List alert rules.", "read", arrayResponse("200", "alertRules", "AlertRule"), emptyResponse("401")), postOp("Create alert rule", "Create a metric, log, or trace alert rule.", "admin", "AlertRuleInput", refResponse("201", "AlertRuleResponse"), emptyResponse("401"))),
			...
			"/api/uptime-monitors":                 pathItem(getOp("Uptime monitors", "List uptime monitors.", "read", arrayResponse("200", "monitors", "UptimeMonitor"), emptyResponse("401")), postOp("Create uptime monitor", "Register a synthetic uptime check.", "admin", "UptimeMonitorInput", refResponse("201", "UptimeMonitorResponse"), emptyResponse("401"))),
...
func openAPISchemas() map[string]any {
	return map[string]any{
		...
		"Host":                        schemaObject(nil, prop("id", stringSchema()), prop("name", stringSchema()), prop("region", stringSchema()), prop("agentVersion", stringSchema()), prop("status", stringSchema()), prop("metrics", numberMap())),
		"HostInput":                   schemaObject(required("name"), prop("name", stringSchema()), prop("region", stringSchema()), prop("agentVersion", stringSchema()), prop("status", stringSchema()), prop("metrics", numberMap()), prop("tags", arrayOf(stringSchema()))),
		...
		"SpanInput":                   schemaObject(required("id", "name"), prop("id", stringSchema()), prop("parentId", stringSchema()), prop("name", stringSchema()), prop("service", stringSchema()), prop("durationMs", numberSchema()), prop("status", stringSchema()), prop("attributes", stringMap())),
		"Trace":                       schemaObject(nil, prop("id", stringSchema()), prop("traceId", stringSchema()), prop("timestamp", dateTimeSchema()), prop("rootService", stringSchema()), prop("operation", stringSchema()), prop("durationMs", numberSchema()), prop("status", stringSchema()), prop("spans", arrayRef("SpanInput")), prop("resources", arrayRef("Resource"))),
		"TraceInput":                  schemaObject(required("traceId", "spans"), prop("traceId", stringSchema()), prop("timestamp", dateTimeSchema()), prop("rootService", stringSchema()), prop("operation", stringSchema()), prop("durationMs", numberSchema()), prop("status", stringSchema()), prop("spans", arrayRef("SpanInput")), prop("resources", arrayRef("Resource"))),
		...
		"AlertRule":                   schemaObject(nil, prop("id", stringSchema()), prop("name", stringSchema()), prop("signal", stringSchema()), prop("enabled", boolSchema()), prop("severity", stringSchema())),
		"AlertRuleInput":              schemaObject(required("name", "signal"), prop("name", stringSchema()), prop("signal", stringSchema()), prop("enabled", boolSchema()), prop("severity", stringSchema())),
		"Incident":                    schemaObject(nil, prop("id", stringSchema()), prop("title", stringSchema()), prop("severity", stringSchema()), prop("status", stringSchema()), prop("owner", stringSchema()), prop("affectedServices", arrayOf(stringSchema()))),
		"IncidentInput":               schemaObject(required("title"), prop("title", stringSchema()), prop("severity", stringSchema()), prop("owner", stringSchema()), prop("affectedServices", arrayOf(stringSchema()))),
		"UptimeMonitor":               schemaObject(nil, prop("id", stringSchema()), prop("name", stringSchema()), prop("url", stringSchema()), prop("method", stringSchema()), prop("expectedStatus", integerSchema()), prop("status", stringSchema()), prop("latencyMs", numberSchema())),
		...
		"NotificationChannel":         schemaObject(nil, prop("id", stringSchema()), prop("name", stringSchema()), prop("kind", stringSchema()), prop("enabled", boolSchema())),
		"NotificationChannelInput":    schemaObject(required("name", "kind"), prop("name", stringSchema()), prop("kind", stringSchema()), prop("enabled", boolSchema()), prop("target", stringSchema())),
		...
		"UptimeMonitorResponse":       wrapper("monitor", "UptimeMonitor"),
		"NotificationChannelResponse": wrapper("channel", "NotificationChannel"),
